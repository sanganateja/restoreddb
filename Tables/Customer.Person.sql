...
[surname] [nchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Person] ADD CONSTRAINT [PK__Person__543B4487DAE7AD57] PRIMARY KEY CLUSTERED  ([person_ID]) ON [PRIMARY]
GO
